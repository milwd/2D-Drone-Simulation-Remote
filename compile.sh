...
g++ -o bins/ObjectPub.out   src/objectpublisher.cpp src/Generated/ObstaclesPubSubTypes.cxx src/Generated/ObstaclesTypeObjectSupport.cxx -I. -I/usr/local/include -I/usr/include/fastdds -I/usr/include/fastcdr -L/usr/local/lib -std=c++11 -lstdc++ -lfastcdr -lfastdds -lcjson

...
void draw_button(WINDOW *parent, int y, int x, const char *label, int width, int height);
...
int main(int argc, char *argv[]) {
    ...
    while (true) {  // TODO SMALLEN THE CRITICAL SECTION OF SEMAPHORE  // TODO CLEAN FUNCTION STUFFS
        ...
        draw_button(win, 2, 42, "Start (I)", 16, 3);
        draw_button(win, 5, 42, "Reset (Y)", 16, 3);
        draw_button(win, 8, 42, "MAP (M)", 16, 3);
        draw_button(win, 11, 42, "Exit (ESC)", 16, 3);
        wattrset(win, COLOR_PAIR(2));
        draw_button(win, 15, 4, "Up-Left (Q)", 16, 3);
        draw_button(win, 15, 23, "Up (W)", 16, 3);
        draw_button(win, 15, 42, "Up-Right (E)", 16, 3);
        draw_button(win, 18, 4, "Left (A)", 16, 3);
        draw_button(win, 18, 23, "Brake (X)", 16, 3);
        draw_button(win, 18, 42, "Right (D)", 16, 3);
        draw_button(win, 21, 4, "Down-Left (Z)", 16, 3);
        draw_button(win, 21, 23, "Down (S)", 16, 3);
        draw_button(win, 21, 42, "Down-Right (C)", 16, 3);
